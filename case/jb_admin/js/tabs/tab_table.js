...
var tab_table={
    ...
    data:function(){
        ...
        // 后面加的，为了控制tab的table是否自动加载
        //if(this.tab_head.autoload==undefined){
        //    var autoload=true
        //}else{
        //    var autoload=this.tab_head.autoload
        //}
    ...
    mounted(){
        ...
        if(!this.childStore.head.init_express){
            // 2021/5/25 屏蔽，这个是老的组件，只需要维护老代码。autoload是新加的属性，好像造成了组件不自动加载，现在将其去掉。
            //if(this.autoload){
                Vue.nextTick(()=>{
