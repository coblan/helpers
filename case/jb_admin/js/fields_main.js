...
// --- default方式 可以引入多个文件
Vue.component('com-field-ele-tree-depend', async (resolve, reject) =>{
    var com = await import(/* webpackChunkName: 'fields_import' */'./field_editor/ele_tree_depend.js')
    resolve(com.default)
})
Vue.component('com-field-ele-transfer', async (resolve, reject) =>{
