    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='new index', max_length=500, validators=[helpers.director.model_func.model_validator.has_str], verbose_name='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='new work', max_length=100, validators=[helpers.director.model_func.model_validator.has_str], verbose_name='\u540d\u79f0')),
